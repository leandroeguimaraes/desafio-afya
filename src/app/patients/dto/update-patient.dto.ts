...
export class UpdatePatientDto extends PartialType(CreatePatientDto) {
    ...
    @ApiProperty({ description: 'Telefone do paciente', example: '+55 11 1234-5678' })
    @IsString()
    @MaxLength(11, {
    ...
    @ApiProperty({ description: 'Data de nascimento do paciente', example: '2000-01-01  - padrão ISO 8601' })
    @IsDateString()
    @IsNotEmpty()
    birthDate?: Date;

    @ApiProperty({ enum: EnumGender, description: 'Gênero do paciente', example: EnumGender.MASCULINO })
